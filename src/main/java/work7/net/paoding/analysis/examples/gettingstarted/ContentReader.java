package work7.net.paoding.analysis.examples.gettingstarted;
...
public class ContentReader {
	...
	public static String readText(Class clazz) throws IOException {
		InputStream in = clazz.getResourceAsStream("/work7/net/paoding/analysis/examples/gettingstarted/ch1/text.txt");
